{{-- Tables and inline styles throughout: this is printed by Chromium via
     Gotenberg, and kept deliberately close to the emailed n8n receipt so a
     donor sees one consistent document. --}}
@php
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:100%;background:#ffffff;">
  ...
  <tr><td style="padding:24px 0 8px;">
    <div style="font:700 13px/1.3 Helvetica,Arial,sans-serif;color:#57606a;letter-spacing:.08em;text-transform:uppercase;margin-bottom:14px;">Donation Receipt</div>
  ...
  <tr><td style="padding:16px 0 0;">
    ...
    @endif
    <div style="margin-top:14px;font:12px/1.6 Helvetica,Arial,sans-serif;color:#57606a;">
